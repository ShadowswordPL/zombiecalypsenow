 ...
 * Original file: C:\\Users\\Sha\\Desktop\\IO\\Look\\src\\es\\ucm\\look\\data\\remote\\restful\\IRemoteService.aidl
 */
...
/**
	 ...
	 * 
	 */
@Override public void addElement(java.lang.String type, float x, float y, float z, java.util.Map properties) throws android.os.RemoteException
{
...
/**
	 ...
	 *            z coordinate
	 */
@Override public void updateElementPosition(int id, float x, float y, float z) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
	 ...
	 *            property value
	 */
@Override public void updateOrAddProperty(int id, java.lang.String propertyName, java.lang.String propertyValue) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public java.util.List getElementsUpdated(float x, float y, float z, float radius, java.lang.String date) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
/**
	 ...
	 *            password
	 */
@Override public void doLogin(java.lang.String username, java.lang.String password) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void getPropertiesUser(int id) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void registerCallback(es.ucm.look.data.remote.restful.IRemoteServiceCallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
